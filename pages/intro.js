        ...
        <main className="px-10 py-4 space-y-16">
          ...
          <section className="space-y-5">
            ...
            <div className="text-slate-500 text-[13px] leading-7 space-y-4">
              <p>
                우리 사이는 사주 일주를 기반으로 그룹 내 구성원들의 궁합을 분석해주는 서비스입니다. 
                친구, 동료, 가족 등 모임 구성원들이 서로 얼마나 잘 맞는지 재미있게 확인해볼 수 있습니다. 
                모임 전체의 N:N 궁합은 물론, 나를 중심으로 여러 친구와의 궁합을 순위로 비교하는 '나와 궁합', 매일 바뀌는 '오늘의 일진', 사주를 쉽게 배울 수 있는 '사주 가이드'까지 다양한 기능을 제공합니다.
              </p>
              <p>
                '우리 사이'라는 이름은 사람과 사람 사이의 인연을 '잇는다'는 의미를 담고 있습니다. 
                단순한 궁합 결과를 넘어, 서로를 더 깊이 이해하고 관계를 돈독히 하는 계기가 되길 바라는 마음으로 만들었습니다.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-5">
            ...
            <div className="text-slate-500 text-[13px] leading-7 space-y-4">
              <p>
                "우리 사이 운명일까?" 라는 호기심 섞인 질문에서 시작되었습니다. 
                기존의 딱딱한 운세 서비스에서 벗어나, 모임 구성원들이 다 함께 웃고 즐기며 서로의 성향을 이해할 수 있는 놀이터를 만들고 싶었습니다. 
                우리 사이를 통해 여러분의 소중한 인연들이 더욱 특별하게 이어지기를 응원합니다.
              </p>
            </div>
          </section>
